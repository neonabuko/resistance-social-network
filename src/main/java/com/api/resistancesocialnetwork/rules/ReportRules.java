...
public class ReportRules {
    public void handle(Rebel sourceRebel, Rebel targetRebel) throws IllegalArgumentException {
        ...
        assert_rebel_not_already_reported_by_source(sourceRebel, targetRebel);
    }
    ...
    private void assert_rebel_not_already_reported_by_source(Rebel sourceRebel, Rebel targetRebel) {
